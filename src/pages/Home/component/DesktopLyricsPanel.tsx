...
const LYRICS_COL_CLASS = classNames(
    "font-calligraphy [writing-mode:vertical-rl] [text-orientation:upright] text-[30px] font-bold tracking-[5px]",
...
export const DesktopLyricsPanel = React.memo((props: Props) => {
    return (
        <div
            className="group/lyrics absolute top-5 left-5 z-10 hidden flex-col items-center border-none bg-transparent p-0 shadow-none min-[851px]:flex min-[1401px]:top-1/2 min-[1401px]:left-6 min-[1401px]:-translate-y-1/2 min-[1401px]:gap-3"
            data-active={props.lyricsActive}
        >
            <MusicToggleButton isPlaying={props.isPlaying} variant="desktop" onToggle={props.onToggle} />
            <div className="hidden flex-row items-start gap-4 min-[1401px]:flex">
