...
const POSITION_CLASS: Record<ElementId, string> = {
    wood: "top-[calc(50%-115px)] left-1/2 min-[601px]:top-[calc(50%-200px)] min-[993px]:top-[calc(50%-245.5px)]",
    fire: "top-[calc(50%-35px)] left-[calc(50%+109px)] min-[601px]:top-[calc(50%-61.8px)] min-[601px]:left-[calc(50%+190.2px)] min-[993px]:top-[calc(50%-75.8px)] min-[993px]:left-[calc(50%+233.4px)]",
    earth: "top-[calc(50%+93px)] left-[calc(50%+67px)] min-[601px]:top-[calc(50%+161.8px)] min-[601px]:left-[calc(50%+117.6px)] min-[993px]:top-[calc(50%+198.6px)] min-[993px]:left-[calc(50%+144.2px)]",
    metal: "top-[calc(50%+93px)] left-[calc(50%-67px)] min-[601px]:top-[calc(50%+161.8px)] min-[601px]:left-[calc(50%-117.6px)] min-[993px]:top-[calc(50%+198.6px)] min-[993px]:left-[calc(50%-144.2px)]",
    water: "top-[calc(50%-35px)] left-[calc(50%-109px)] min-[601px]:top-[calc(50%-61.8px)] min-[601px]:left-[calc(50%-190.2px)] min-[993px]:top-[calc(50%-75.8px)] min-[993px]:left-[calc(50%-233.4px)]",
};
...
const SIZE_CLASS = "size-20 min-[601px]:size-42.5 min-[993px]:size-48";
