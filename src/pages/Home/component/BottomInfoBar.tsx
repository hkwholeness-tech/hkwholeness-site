...
export const BottomInfoBar = React.memo(() => {
    return (
        <div className="pointer-events-auto absolute inset-x-0 bottom-42.5 z-30 flex w-full items-center justify-center min-[851px]:inset-x-3.75 min-[851px]:bottom-6.25 min-[851px]:z-20 min-[1401px]:inset-x-0 min-[1401px]:pointer-events-none">
            <div className="pointer-events-auto relative flex w-full items-center justify-center gap-5 p-0 min-[851px]:justify-between min-[1401px]:justify-center min-[1401px]:px-32.5">
                ...
                <div className="font-calligraphy relative m-0 box-border w-[96%] rounded-xl border border-[rgba(218,208,192,0.6)] bg-[rgba(255,253,250,0.92)] pt-4.5 pr-px pb-11.25 pl-1.25 text-center text-lg/normal font-semibold tracking-[0.8px] whitespace-normal text-[#3d2a14] shadow-[0_4px_15px_rgba(0,0,0,0.08)] backdrop-blur-[6px] min-[851px]:w-auto min-[851px]:rounded-lg min-[851px]:bg-[rgba(255,253,250,0.88)] min-[851px]:px-7 min-[851px]:py-3 min-[851px]:text-[22px] min-[851px]:leading-[1.6] min-[851px]:whitespace-nowrap min-[851px]:shadow-[0_3px_10px_rgba(44,37,30,0.05)]">
                    {ADDRESS_LINE_1}
                    <br className="block min-[851px]:hidden" />
                    {ADDRESS_LINE_2}
                    <br />
                    {PHONE_LINE}
                </div>
